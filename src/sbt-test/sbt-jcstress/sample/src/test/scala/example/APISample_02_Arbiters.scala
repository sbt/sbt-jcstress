...
@JCStressTest
@Outcomes(Array(
  new Outcome(id = Array("1"), expect = Expect.ACCEPTABLE_INTERESTING, desc = "One update lost: atomicity failure."),
  new Outcome(id = Array("2"), expect = Expect.ACCEPTABLE, desc = "Actors updated independently.")
))
@State
class APISample_02_Arbiters {
